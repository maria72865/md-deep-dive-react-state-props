  ...
  render() {
    ...
    return (
      <div>
        ...
        <button class="btn" onClick={this.clearEntries}>Clear Journal Entries</button>
        <button class="btn" onClick={this.showAllEntries}>Show All Journal Entries</button>
        <button class="btn" onClick={this.toggleStatus}>Toggle Status</button>
        </div>
      </div>
    );
  }
